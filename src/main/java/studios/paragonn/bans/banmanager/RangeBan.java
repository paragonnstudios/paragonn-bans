...
public class RangeBan extends Punishment implements Comparable<RangeBan>
{
    ...
    public String getKickMessage() {
        return Msg.get("disconnection.you-are-rangebanned", new String[] { "reason", "banner", "appeal-message", "range" }, new String[] { this.getReason(), this.getBanner(), PBans.instance.getBanManager().getAppealMessage(), this.toString() });
    }
}
