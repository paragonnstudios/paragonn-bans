...
public class MBDebugCommand extends CmdSkeleton
{
    ...
    public boolean run(final CommandSender sender, final Command command, final String label, final String[] args) {
        ...
        Label_0184: {
            ...
            if (args[0].equalsIgnoreCase("console")) {
                ...
                if (!args[0].equalsIgnoreCase("chat")) {
                    ...
                    sender.sendMessage("/mbdebug file - Outputs debug info to Server\\plugins\\PBans\\debug.txt");
        ...
        System.out.println();
        out.print("PBans Data Dump - " + dateFormat.format(date));
        ...
        out.print("=== Vanilla Bans (PBans does not handle these) ===");
