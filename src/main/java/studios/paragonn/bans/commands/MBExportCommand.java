...
import studios.paragonn.bans.commands.bridge.SQLiteBridge;
import java.io.File;
import studios.paragonn.bans.database.SQLiteCore;
import java.sql.SQLException;
import studios.paragonn.bans.commands.bridge.MySQLBridge;
import studios.paragonn.bans.database.Database;
import org.bukkit.ChatColor;
import studios.paragonn.bans.database.MySQLCore;
import studios.paragonn.bans.commands.bridge.VanillaBridge;
...
public class MBExportCommand extends CmdSkeleton
{
    ...
    public boolean run(final CommandSender sender, final Command cmd, final String label, final String[] args) {
        if (args.length == 0) {
            sender.sendMessage(Formatter.primary + "PBans Exporter:");
